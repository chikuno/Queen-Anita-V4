...
global.anitav4 = process.env.BOT_NAME || "Sinbad Bot";
global.ownername = process.env.OWNER_NAME || "Silhouette";
global.packname = process.env.PACK_NAME || "Sinbad Bot";
global.author = process.env.AUTHOR || "Silhouette ";
global.channelname = process.env.CHANNEL_NAME || "Sinbad";
...
global.autoLikeEmoji = process.env.AUTO_LIKE_EMOJI || "🏴‍☠️";
